...
![image-20210906105652113](https://picture.lingzero.cn/202208071837741.png) 
...
![image-20210906105157409](https://picture.lingzero.cn/202208071837742.png)

点击进入后，下载Source code(zip)：

![image-20210906105102668](https://picture.lingzero.cn/202208071837743.png)
...
![image-20210906105858000](https://picture.lingzero.cn/202208071837744.png) 

导入该项目后，查看其项目结构：

![image-20210906110014198](https://picture.lingzero.cn/202208071837745.png) 
...
![image-20210906111053263](https://picture.lingzero.cn/202208071837746.png) 

然后，使用IDEA将其作为一个module来导入：

1）选择项目结构选项：

![image-20210906111152447](https://picture.lingzero.cn/202208071837747.png) 

然后点击导入module：

![image-20210906111259352](https://picture.lingzero.cn/202208071837748.png) 

在弹出窗口中，选择nacos源码目录：

![image-20210906111422406](https://picture.lingzero.cn/202208071837749.png)

然后选择maven模块，finish：

![image-20210906111519198](https://picture.lingzero.cn/202208071837750.png)

最后，点击OK即可：

![image-20210906111543747](https://picture.lingzero.cn/202208071837751.png)

导入后的项目结构：

![image-20210906111632336](https://picture.lingzero.cn/202208071837752.png)
...
![image-20210906111941399](https://picture.lingzero.cn/202208071837753.png)
...
![image-20210906112814549](https://picture.lingzero.cn/202208071837754.png)

另外，课前资料也提供了下载好的安装包：

![image-20210906112920575](https://picture.lingzero.cn/202208071837755.png) 



解压到任意非中文目录下，其中的bin目录中的protoc.exe可以帮助我们编译：

![image-20210906113011871](https://picture.lingzero.cn/202208071837756.png)

然后将这个bin目录配置到你的环境变量path中，可以参考JDK的配置方式：

![image-20210906113552081](https://picture.lingzero.cn/202208071837757.png)
...
![image-20210906113655302](https://picture.lingzero.cn/202208071837758.png)
...
![image-20210906113829647](https://picture.lingzero.cn/202208071837759.png)

会在nacos的consistency模块中编译出这些java代码：

![image-20210906113923430](https://picture.lingzero.cn/202208071837760.png)
...
![image-20210906114035628](https://picture.lingzero.cn/202208071837761.png) 

我们需要让它单机启动：

![image-20210906114143669](https://picture.lingzero.cn/202208071837762.png) 

然后新建一个SpringBootApplication：

![image-20210906114220412](https://picture.lingzero.cn/202208071837763.png) 

然后填写应用信息：

![image-20210906114519073](https://picture.lingzero.cn/202208071837764.png)



然后运行Nacos这个main函数：

![image-20210906114705910](https://picture.lingzero.cn/202208071837765.png)



将order-service和user-service服务启动后，可以查看nacos控制台：

![image-20210906151358154](https://picture.lingzero.cn/202208071837766.png)
...
![image-20210922111651314](https://picture.lingzero.cn/202208071837767.png)
...
![image-20210907201333049](https://picture.lingzero.cn/202208071837768.png)
...
![image-20210907201612322](https://picture.lingzero.cn/202208071837769.png)
...
![image-20210907213647145](https://picture.lingzero.cn/202208071837770.png)
...
![image-20210907214111801](https://picture.lingzero.cn/202208071837771.png)

可以看到它实现了`ApplicationListener`接口，监听Spring容器启动过程中的事件。

在监听到`WebServerInitializedEvent`（web服务初始化完成）的事件后，执行了`bind` 方法。

![image-20210907214411267](https://picture.lingzero.cn/202208071837772.png)
...
![image-20210907215903335](https://picture.lingzero.cn/202208071837773.png)
...
![image-20210908141019175](https://picture.lingzero.cn/202208071837774.png)
...
![image-20210923185331470](https://picture.lingzero.cn/202208071837775.png)
...
![image-20210922112801808](https://picture.lingzero.cn/202208071837776.png)

模块结构如下：

![image-20210922112954630](https://picture.lingzero.cn/202208071837777.png)

其中的com.alibaba.nacos.naming.controllers包下就有服务注册、发现等相关的各种接口，其中的服务注册是在`InstanceController`类中：

![image-20210922113158618](https://picture.lingzero.cn/202208071837778.png)
...
![image-20210922141703128](https://picture.lingzero.cn/202208071837779.png)
...
![image-20210922161705573](https://picture.lingzero.cn/202208071837780.png)
...
![image-20210922180246555](https://picture.lingzero.cn/202208071837781.png)
...
![image-20210922195603450](https://picture.lingzero.cn/202208071837782.png)
...
![image-20210923214042926](https://picture.lingzero.cn/202208071837783.png)
...
![image-20210922213313677](https://picture.lingzero.cn/202208071837784.png)
...
![image-20210922213455549](https://picture.lingzero.cn/202208071837785.png)
...
![image-20210922213829632](https://picture.lingzero.cn/202208071837786.png)
...
![image-20210922221022107](https://picture.lingzero.cn/202208071837787.png)
...
![image-20210922221344417](https://picture.lingzero.cn/202208071837788.png)
...
![image-20210923100740065](https://picture.lingzero.cn/202208071837789.png)
...
![image-20210923102824451](https://picture.lingzero.cn/202208071837790.png)
...
![image-20210923153419392](https://picture.lingzero.cn/202208071837791.png)
...
- 如果本地缓存没有，立即去nacos读取，`updateServiceNow(serviceName, clusters)`
  ...
  ![image-20210923161528710](https://picture.lingzero.cn/202208071837792.png)

- 如果本地缓存有，则开启定时更新功能，并返回缓存结果：

  - `scheduleUpdateIfAbsent(serviceName, clusters)`

  ![image-20210923161630575](https://picture.lingzero.cn/202208071837793.png)

  在UpdateTask中，最终还是调用updateService方法：

  ![image-20210923161752521](https://picture.lingzero.cn/202208071837794.png)
...
![image-20210923164145915](https://picture.lingzero.cn/202208071837795.png)
...
![image-20210923182429636](https://picture.lingzero.cn/202208071837796.png)

这个是事件监听器接口，监听的是ServiceChangeEvent（服务变更事件）。

当服务列表变化时，就会通知我们：

![image-20210923183017424](https://picture.lingzero.cn/202208071837797.png)
